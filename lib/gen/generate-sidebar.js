...
exports.default = function (contracts, contractsPath, excludePaths, docusaurusPath) {
  ...
  var previousSidebarView = JSON.parse(_fs2.default.readFileSync(sidebarPath));
  ...
  var sidebarContent = _mustache2.default.render(sidebarTemplate, Object.assign({}, sidebarView, previousSidebarView));
  _fs2.default.writeFileSync(sidebarPath, sidebarContent);
};
...
function getDocsPerSection(contracts, contractsPath, excludePaths) {
  ...
  var _loop = function _loop(contract) {
    ...
    if (excludePaths.some(function (prefix) {
